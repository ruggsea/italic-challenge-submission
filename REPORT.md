...
|---|---|---|
| **extkd-s1500 (SHIP)** | **0.4932 / 0.4929 / 0.4921** | M2 + Stage-3 softKD on 28,561 external in-distribution committee items, step 1500; triple-confirmed |
...
2. Stage 2 (M2): culture softKD on 22,950 Mistral-24B PUBLIC committee items, T=2.0, lmbda_ce=0.5, LR=2e-5, seed=99 -> ckpt s2000.
