...
Measured replay cost ≈4.7 H100h (generation 0.15 + committee labeling 0.53 + one softKD run
3.70 + official eval 0.28; H200 wall clock × 1.2). The from-base clean-run model scored
