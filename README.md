...
2. **Training pool** ([ruggsea/italic-softkd-pool](https://huggingface.co/datasets/ruggsea/italic-softkd-pool), 21,606 items, committee soft labels included; also published as three component datasets: [knowledge](https://huggingface.co/datasets/ruggsea/italic-softkd-knowledge), [grammar](https://huggingface.co/datasets/ruggsea/italic-softkd-grammar), [synthetic ortho/morph](https://huggingface.co/datasets/ruggsea/italic-softkd-orthomorph)): 11,453 knowledge MCQs (pinocchio-derived, teacher-filtered), 5,432 committee-labeled grammar MCQs, and ~4,700 generated orthography/morphology MCQs targeting the categories where public data is scarce. Everything is decontaminated against the ITALIC test set (exact match plus semantic similarity at cosine 0.80; see `data/decontam_manifest.json`, 0 exact leaks, max similarity 0.7999).
